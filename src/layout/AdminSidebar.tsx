...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Tagihan", path: "/dashboard/admin/billings", badge: 1 },
      { name: "Pembayaran", path: "/dashboard/admin/payouts", badge: 1 },
    ],
  },
  {
...

  {
    ...
    subItems: [
      {
        name: "Admin",
        path: "/dashboard/admin/users/admin",
        badge: 1,
      },
      { name: "Pemilik Kost", path: "/dashboard/admin/users/owner", badge: 1 },
      { name: "Penyewa Kost", path: "/dashboard/admin/users/tenant", badge: 1 },
    ],
  },
  {
    name: "Pengaturan",
    icon: <Settings />,
    path: "/dashboard/admin/pengaturan/profile",
  },
];
