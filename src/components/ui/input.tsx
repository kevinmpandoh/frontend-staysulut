...
// className =
//   "w-full rounded border border-[#D9D9D9] mb-4 bg-white px-4 py-3 text-base text-[#7A7A7A] placeholder-[#7A7A7A] focus:outline-none focus:ring-1 focus:ring-[#5B6DEE]";
