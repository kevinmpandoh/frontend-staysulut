...
const HeroSection = () => {
  return (
    <section className="bg-blue-100 text-slate-600 mx-auto py-16 mt-20 px-4 md:px-12 xl:px-36 flex flex-col-reverse md:flex-row items-center justify-between">
      {/* Left Side */}
